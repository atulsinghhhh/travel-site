...
import { BookOpen, Calendar, Globe, Lightbulb } from "lucide-react";
...
function Sidebar() {
    ...
    return (
        <div className="w-64 bg-white border-r border-gray-200 flex flex-col justify-between text-gray-900 h-full">
