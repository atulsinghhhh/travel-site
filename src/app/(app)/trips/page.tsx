    ...
    return (
        ...
        <div className="flex-1 p-6 overflow-y-auto bg-gray-800 text-white">
            ...
            <TabsContent value="upcoming">
                ...
                ) : upcomingTab.length > 0 ? (
                <TripsList trips={upcomingTab} />
                ) : (
            ...
            <TabsContent value="canceled">
                {loading ? (
                <p>Loading canceled trips...</p>
                ) : canceledTab.length > 0 ? (
                <TripsList trips={canceledTab} />
                ) : (
                <p className="text-gray-500">No canceled trips.</p>
                )}
            </TabsContent>
            </Tabs>
        </div>
